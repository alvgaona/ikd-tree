...
KdTree<PointType>::KdTree(float delete_param, float balance_param, float box_length, int rebuild_log_capacity)
    : threads_(std::make_unique<Threads>()), Rebuild_Logger(rebuild_log_capacity) {
